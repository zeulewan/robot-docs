...
| Preview project | `unitree-wheelchair-minimal-yaw-locked-velocity-push-attached` |
| Preview watcher | `isaac_clip_watch_wheelchair_minimal_yaw_locked_every250` |
