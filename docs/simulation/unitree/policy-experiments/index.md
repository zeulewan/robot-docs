...
| [G1 wheelchair standing bridge](wheelchair-push-demo.md#standing-first-attached-pretrain) | `Unitree-G1-29dof-Wheelchair-Dynamic-Stand-Observed-Neutral` | Active bridge from plain standing into wheelchair-present standing before reintroducing handle pose and hand-handle attachment. |
