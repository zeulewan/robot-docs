...
| [G1 fixed-base wheelchair hold](wheelchair-push-demo.md#standing-first-attached-pretrain) | `Unitree-G1-29dof-Wheelchair-Fixed-Stand-Attached` | Active first holding primitive; hands are attached to the handles while the wheelchair root is fixed for balance pretraining. |
