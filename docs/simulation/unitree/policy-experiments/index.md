...
| [G1 partial reach-arm standing bridge](wheelchair-push-demo.md#standing-first-attached-pretrain) | `Unitree-G1-29dof-Stand-Reach-Arms` | Active safer bridge; trains standing with a partial handle-reaching arm pose before the full handle pose and free wheelchair are reintroduced. |
