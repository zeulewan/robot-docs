...
| [G1 PhysX rail torque diagnostic](wheelchair-push-demo.md#x-rail-fast-lean-2-ms-variant) | `Unitree-G1-29dof-Wheelchair-Minimal-PhysX-Rail-Fast-Lean-Velocity-Progress-Push-Attached` | Playback-only diagnostic; replaces the kinematic X-rail clamp with a prismatic articulation joint so wheelchair rail reaction yaw torque can be measured. |
| [G1 PhysX rail soft-attachment adaptation](wheelchair-push-demo.md#physx-rail-training-stabilization) | `Unitree-G1-29dof-Wheelchair-Minimal-PhysX-Rail-1mps-Yaw-Torque-Push-Attached` | Active run at `12288` envs; keeps the good rail policy lineage but replaces hard hand-handle joints with bounded soft attachments for stable high-parallel training. |
