...
| ZBT WG827 Router | 192.168.123.1 | OpenWrt router added by Indro Robotics (velcroed to back). Provides WiFi (SSID: UnitreeG1-Router) and optional 4G/5G. SSH/LuCI: root / ***REMOVED*** |
...
- **SSID:** `UnitreeG1-Router`, **Password:** `***REMOVED***`, Channel 11 (2.4GHz), WPA2
